...
- Budgeted income: £`r as.numeric(budget2223[18, 1])`

- Budgeted expenditure: £`r as.numeric(budget2223[18, 2])`

- Budgeted deficit: £`r -(as.numeric(budget2223[18, 3]))`
...
- **The current deficit is £`r -as.numeric(dta.sum[num.months,2] - dta.sum[num.months,3])`**. 
