...
- Total income since 1 July 2022 is £`r as.numeric(dta.sum[num.months, 2])`

- Total expenditure since 1 July 2022 £`r as.numeric(dta.sum[num.months, 3])`

- **The current deficit is £`r -as.numeric(dta.sum[num.months,2] - dta.sum[num.months,3])`**. 
- Current bank balance £`r Bank_Balance`.

- Number of subscriptions paid to date: 
  `r format((actuals2223[2,1] / 45), nsmall = 0)`
